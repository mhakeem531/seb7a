 ...
 * {@link TawheedFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link TawheedFragment#newInstance} factory method to
...
public class TawheedFragment extends Fragment {
    ...
    private long counter = Variables.tawhed_count;
     ...
     * @return A new instance of fragment TawheedFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TawheedFragment newInstance(String param1, String param2) {
        TawheedFragment fragment = new TawheedFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button = rootView.findViewById(R.id.tawheed_button);
        ...
        button.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    counter++;
                    counterTextView.setText(convertToArabicNumber(String.valueOf(counter)));
                    Variables.tawhed_count = counter;
