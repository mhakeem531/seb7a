 ...
 * {@link TasbeehFragment.OnFragmentInteractionListener} interface
...
public class TasbeehFragment extends Fragment {
    ...
    private long counter = Variables.tasbeeh_count;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_tasbeeh, container, false);
        ...
        button = rootView.findViewById(R.id.tasbeeh_button);
        ...
        button.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    counter++;
                    counterTextView.setText(convertToArabicNumber(String.valueOf(counter)));
                    Variables.tasbeeh_count = counter;
